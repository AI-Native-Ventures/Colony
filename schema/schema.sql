...
-- 0071: Website Manager jobs — canonical review state and once-only actions.
--
...
SELECT attach_community_write_fence('website_actions');
SELECT attach_community_write_fence('website_jobs');
