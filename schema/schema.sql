...
CREATE TABLE events (
    ...
    search_tsv  TSVECTOR GENERATED ALWAYS AS (
        CASE WHEN kind IN (1059, 30179, 30180, 30181, 30300, 30350, 30622, 40013, 40014, 40015, 40016, 40017, 40018, 40019, 40020, 40021, 40022, 44100, 44101, 44200) THEN NULL::tsvector
