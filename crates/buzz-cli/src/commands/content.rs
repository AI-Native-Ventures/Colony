...
//!
//! Campaigns (30195), posts (30196), and house style (30197) are written by
//! the content agent; decisions (40025) are written by the owner. Every write
//! here self-validates against the same `buzz_core::content` parser the relay
//! runs at ingest, so a rejection arrives without a network round trip and
