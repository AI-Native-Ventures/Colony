...
impl Db {
    ...
    pub async fn is_relay_member(&self, community: CommunityId, pubkey: &str) -> Result<bool> {
        crate::relay_members::is_relay_member(&self.pool, community, pubkey).await
    }

    /// Returns `true` if any member of `community` holds the `admin` or
    /// `owner` role. See [`crate::relay_members::has_admin_or_owner`].
    pub async fn has_admin_or_owner(&self, community: CommunityId) -> Result<bool> {
        crate::relay_members::has_admin_or_owner(&self.pool, community).await
    }
    ...
    pub async fn get_relay_member(
        ...
        crate::relay_members::get_relay_member(&self.pool, community, pubkey).await
    }
    ...
    pub async fn list_relay_members(
        ...
        crate::relay_members::list_relay_members(&self.pool, community).await
    }
    ...
    pub async fn add_relay_member(
        ...
        crate::relay_members::add_relay_member(&self.pool, community, pubkey, role, added_by).await
    }
    ...
    pub async fn has_join_policy_acceptance(
        ...
        crate::relay_members::has_join_policy_acceptance(
            &self.pool,
            community,
            pubkey,
            policy_version,
    ...
    pub async fn remove_relay_member(
        ...
        crate::relay_members::remove_relay_member(&self.pool, community, pubkey).await
    }
    ...
    /// prior role read and the delete. See [`crate::relay_members::remove_relay_member_if_role`].
    pub async fn remove_relay_member_if_role(
        &self,
        community: CommunityId,
        pubkey: &str,
        ...
        crate::relay_members::remove_relay_member_if_role(
            &self.pool,
            community,
            pubkey,
            expected_role,
    ...
    pub async fn update_relay_member_role(
        ...
        crate::relay_members::update_relay_member_role(&self.pool, community, pubkey, new_role)
            .await
    }
    ...
    pub async fn bootstrap_owner(&self, community: CommunityId, owner_pubkey: &str) -> Result<()> {
        crate::relay_members::bootstrap_owner(&self.pool, community, owner_pubkey).await
    }
    ...
    pub async fn transfer_ownership(
        ...
        new_owner_pubkey: &str,
        expected_owner_pubkey: &str,
    ) -> Result<crate::relay_members::TransferResult> {
        crate::relay_members::transfer_ownership(
            &self.pool,
            community,
            new_owner_pubkey,
    ...
    pub async fn backfill_from_allowlist(&self, community: CommunityId) -> Result<u64> {
        crate::relay_members::backfill_from_allowlist(&self.pool, community).await
    }
