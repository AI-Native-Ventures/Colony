 ...
 *
 * The preview identity is exact: owner window, community, artifact, thread root,
...
/** Validate a bounded community identifier. */
...
export function validateOpenRequest(request) {
  ...
  const artifactId = requireSha256(request.artifactId, "artifactId");
  ...
  return {
    ...
    communityId,
    artifactId,
    mountId: request.mountId === undefined ? "default" : requireId(request.mountId, "mountId"),
    threadRoot,
