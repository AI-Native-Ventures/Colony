 ...
 *
 * One `WebContentsView` per preview identity (owner window, community, artifact,
 ...
 * The wrapper is selected only on macOS. This reset still requires packaged
 * rendering proof; other platforms hide partially clipped previews.
 */
