/**
 * The managed-agent wire shape and its mapping into the app-facing
 * `ManagedAgent`. Split out of `tauri.ts` so the raw record can grow without
 * pushing that module past the file-size ratchet.
 */
