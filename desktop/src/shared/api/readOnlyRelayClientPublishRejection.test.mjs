...
// Colony routes every native call through the NativeBridge indirection rather
// than reaching into `__TAURI_INTERNALS__`, so the send transport is installed
// here instead of on `window`.
