              ...
              {mode === "edit" && workflowSnapshot ? (
                <>
                  <Popover onOpenChange={setHistoryOpen} open={historyOpen}>
                    {/* Upstream comments this entry point out pending a
                    NIP-11 capability gate. Colony keeps it: run history and
                    the Run-again affordance are shipped features here (the
                    authoritative reads landed with #5780), and leaving the
                    popover with no trigger would delete a working Colony
                    feature rather than defer an unbuilt one. */}
