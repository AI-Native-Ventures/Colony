 ...
 *  tree transitively imports a .css file (ColonyLogoAnimation.tsx →
 *  colony-logo-animation.css) and the test-loader has no CSS stub. The
...
// ColonyLogoAnimation.tsx → colony-logo-animation.css). The test below verifies the
