...
const STAGE_CHARACTERS: readonly StageCharacter[] = [
  { name: "Scout", animationUrl: "/onboarding/starter-team/fizz.png" },
  { name: "Forager", animationUrl: "/onboarding/starter-team/honey.png" },
  { name: "Tender", animationUrl: "/onboarding/starter-team/bumble.png" },
];
