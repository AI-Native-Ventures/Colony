...
// Monochrome brand marks rendered inline with `currentColor` so they adapt to
// dark/light themes without the brightness/invert filter the old PNG pipeline
// needed. Provenance for each path is recorded in
