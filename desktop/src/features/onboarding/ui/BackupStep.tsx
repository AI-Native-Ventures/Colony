...
export function BackupStep({
  ...
  const introStorageDescription =
    identityStorage === "system-keyring"
      ? "Colony keeps your identity key in your system keychain."
      : identityStorage === "local-file"
        ? "Colony keeps your identity key in a private file on this device because the system keychain wasn’t available."
