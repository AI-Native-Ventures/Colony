...
// The port lane split ACP discovery out of `@/shared/api/tauri` into its own
// module for the file-size ratchet, so the stub has to live where
// `welcomeGuide.ts` now imports it from.
