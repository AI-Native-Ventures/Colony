...
// Colony composer chips resolve `buzz://message?...` links; the
// `buzz://channel/<id>` path form upstream uses here is not supported yet.
const CHANNEL_HREF = `buzz://message?channel=${CHANNEL_ID}&id=root-event`;
