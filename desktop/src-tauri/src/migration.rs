...
#[path = "migration_avatar_refresh.rs"]
mod avatar_refresh;
use avatar_refresh::refresh_builtin_agent_avatars;
#[cfg(test)]
use avatar_refresh::{
    refresh_builtin_agent_avatars_in_file, LegacyBuiltInAvatar, LEGACY_BUILTIN_AVATARS,
};
