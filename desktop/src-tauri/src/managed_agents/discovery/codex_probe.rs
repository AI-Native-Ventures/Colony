...
/// that does not reliably give `buzz` CLI subprocesses outbound relay access, or that
/// cannot use newer models. Adapter 1.6.2 bundles Codex 0.148.x, which rejects
