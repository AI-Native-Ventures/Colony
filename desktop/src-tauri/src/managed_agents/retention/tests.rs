//! Unit tests for the retention store.
//!
//! Split out of `retention.rs` to keep that file under the desktop file-size
//! ratchet after the develop sync; no test bodies changed in the move.
