...
// Discovery-path cases live next door to keep this file under the size
// ratchet; they share this module's imports through the include below.
#[path = "agent_models_discovery_tests.rs"]
mod discovery_tests;
