...
// Colony adds the Block overlay kinds (40010 action, 40011 receipt) to the live
// channel filter, so reconnect repair has to page them back too.
const CHANNEL_REPAIR_KINDS: [u32; 17] = [
    5, 7, 9, 9005, 40001, 40002, 40003, 40008, 40010, 40011, 40099, 45001, 45003, 48100, 48101,
    48102, 48103,
];
