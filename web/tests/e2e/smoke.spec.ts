    ...
    await route.fulfill({
      ...
      body: JSON.stringify([
        { draft: false, prerelease: false, assets: [] },
        {
          ...
          assets: [
            {
              name: "Colony_0.4.9_aarch64.dmg",
              browser_download_url:
                "https://github.com/nocodeafrica/AI-Native-Ventures-App/releases/download/v0.4.9/Colony_0.4.9_aarch64.dmg",
            },
            {
              name: "Colony_0.4.9_x64.dmg",
              browser_download_url:
                "https://github.com/nocodeafrica/AI-Native-Ventures-App/releases/download/v0.4.9/Colony_0.4.9_x64.dmg",
            },
            {
              name: "Colony_0.4.9_amd64.AppImage",
              browser_download_url:
                "https://github.com/nocodeafrica/AI-Native-Ventures-App/releases/download/v0.4.9/Colony_0.4.9_amd64.AppImage",
            },
            {
              name: "Colony_0.4.9_x64-setup_alpha-unsigned.exe",
              browser_download_url:
                "https://github.com/nocodeafrica/AI-Native-Ventures-App/releases/download/v0.4.9/Colony_0.4.9_x64-setup_alpha-unsigned.exe",
            },
          ],
        },
      ]),
