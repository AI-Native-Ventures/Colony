...
class SearchPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isColonyTheme = context.appColors.topSectionGradient != null;
    final colonySearchColor = context.theme.brightness == Brightness.dark
        ? Colors.white
        : Colors.black;
    final searchSurfaceColor = isColonyTheme
        ? colonySearchColor.withValues(alpha: 0.04)
        : context.colors.surfaceContainerHighest;
    final searchMutedColor = isColonyTheme
        ? colonySearchColor.withValues(alpha: 0.4)
