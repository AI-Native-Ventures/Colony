  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Padding(
            // Huddle lifecycle rows sit on the same author/body rhythm as an
            // ordinary message: real padding rather than a negative transform,
            // so the row grows with text scaling instead of clipping.
