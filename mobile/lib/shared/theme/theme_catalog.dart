...
const themeCatalog = <ThemeColors>[
  ...
  // Colony and Colony Dark are first-party: they borrow the GitHub Light /
  // GitHub Dark palettes wholesale and are distinguished only by the branded
  // gradient painted across the app's top section (see colony_theme.dart).
  ThemeColors(
    name: 'colony',
    bg: Color(0xFFFFFFFF),
    fg: Color(0xFF24292E),
